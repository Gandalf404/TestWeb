...
public class KitRepository(InvoicesContext invoicesContext) : IKitRepository
{
    ...
    public async Task<bool> CreateKitAsync(Kit kit)
    {
    ...
    public async Task<bool> IsKitExistAsync(int kitId)
    {
        return await _invoicesContext.Kits.AnyAsync(c => c.KitId == kitId);
    }
